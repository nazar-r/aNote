...
const LobbyPageContent = () => {
    ...
    const scroll = (dir: "left" | "right") => viewportRef.current?.scrollBy({ left: dir === "left" ? -300 : 300, behavior: "smooth" });
    ...
    const saveNote = (note: notesData) => note.content.trim() && mutate(
            ...
            <div className="lobby-page">
                ...
                <div className="lobby-page__viewport" ref={viewportRef} style={{ overflow: "hidden", position: "relative" }}>
                    <motion.div ref={trackRef} className="lobby-page__container" drag="x" style={{ display: "flex" }}>
                        <svg onClick={createNote} className="lobby-page__container--add" width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g opacity="1">
                        ...
                        {localNotes.map(note => (
                            <div key={note.noteId} id={note.noteId} className="lobby-note" style={{ flexShrink: 0, minWidth: 280 }}>
                                ...
                                <div className="lobby-note__hidden">
                                    <div className="lobby-note__hidden--item" onClick={e => {
                                        e.stopPropagation(); defEdit
                                            ? saveNote(note)
                                            : switchEdit(e)
                                    }}> {defEdit
